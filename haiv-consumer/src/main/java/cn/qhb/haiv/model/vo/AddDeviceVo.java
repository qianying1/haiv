...
public class AddDeviceVo implements Serializable {
     ...
     * 名称：用户自定义名称
     */
//    @ApiModelProperty(name = "name", notes = "名称：用户自定义名称", dataType = "formData", required = true)
    private String name;
    /**
     * 设备型号
     */
//    @ApiModelProperty(name = "assetModel", notes = "设备型号", dataType = "formData", required = true)
    private String assetModel;
    /**
     * cpu型号
     */
//    @ApiModelProperty(name = "cpuModel", notes = "cpu型号", dataType = "formData", required = true)
...
//    @ApiModelProperty(name = "manufacturer", notes = "厂商", dataType = "formData")
     ...
     * 序列号
     */
//    @ApiModelProperty(name = "seriesNum", notes = "序列号", dataType = "formData", required = true)
...
//    @ApiModelProperty(name = "ofbIp", notes = "带外ip", dataType = "formData")
     ...
     * 负责人
     */
//    @ApiModelProperty(name = "respMan", notes = "负责人", dataType = "formData", required = true)
    private String respMan;
    /**
     * 状态：在用/下线
     */
//    @ApiModelProperty(name = "status", notes = "状态：在用/下线[online/offline]，默认为offline", dataType = "Device.Status")
    private Device.Status status = Device.Status.offline;
    /**
     * 用途
     */
//    @ApiModelProperty(name = "usage", notes = "用途", dataType = "formData", required = true)
...
//    @ApiModelProperty(name = "dataStatus", notes = "信息状态：填报状态，缺/ok[lack/ok]；默认为lack", dataType = "formData")
     ...
     * 过保日期：yyyy/mm/dd
     */
//    @ApiModelProperty(name = "ofd", dataType = "date", notes = "过保日期，格式为：yyyy/mm/dd")
    @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    private Date ofd;
    /**
     * 过保天数
     */
//    @ApiModelProperty(name = "过保天数", dataType = "int", notes = "过保天数：默认为0")
    private Integer dofd = 0;
    /**
     * 机柜id
     */
//    @ApiModelProperty(name = "cahinetId", hidden = true, notes = "所属机柜的id")
