...
//    	int day = getMonthSpace(convertStringToDate2("2015-04-10"), convertStringToDate2("2016-02-09"));
//    	System.out.println(day);
//    	System.out.println(convertDateToString2(dateAdd(getCurrentDate(), Calendar.DATE, -1)));
        Properties p = getProperties("/project.properties");
	...
	/*public static List<Object> extractToList(final Collection collection, final String propertyName) {
		...
		try {
			...
			System.err.println("extractToList: " + e.getMessage());
		}
    ...
    public static String getLastDayOfMonth(int year, int month) {
        ...
        String lastDayString = Utils.convertDateToString2(lastDayOfMonth);
     ...
     * @return
     */
    public static String getNextMonthFirstDay(Integer year, Integer month) {
     ...
     * @return
     */
    public static List<?> arrayConvertToList(Object... objs) {
     ...
     * @return
     */
    public static Object[] listConvertToArray(List<?> list) {
